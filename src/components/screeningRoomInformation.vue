            ...
            <el-col :span="8"><div class="grid-content bg-purple">
                ...
                <el-collapse-item title="新建影厅" name="2">
                    <div>
                        <el-row>
                            <el-col :span="24"><div class="grid-content">
                            <el-input v-model="input" placeholder="请输入新建的影厅名"></el-input>
                            </div></el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="24"><div class="grid-content">
                            <el-button type="primary" @click="addRoom">新建影厅</el-button>
                                <el-button @click="offRoom">取消新建</el-button>
                            </div></el-col>
                        </el-row>
                    </div>
                </el-collapse-item>
